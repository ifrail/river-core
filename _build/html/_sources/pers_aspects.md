...
Распределение аспектов между архетипами может быть любым, однако помните, что в любом архетипе аспектов не может быть более шести, а в стартовом архетипе их должно быть минимум два! Выбирайте то, что лучше соответствует вашей задумке. Если **аспект** не совсем соответствует заявке, то это приведет к снижению эффективности и **Мастер** объявит об этом. Чаще всего это касается профессиональных аспектов, овладение которыми занимает продолжительное время.

> _**Пример**: Джейн хочет найти следы, оставленные браконьерами в лесу, но у нее нет аспектов **Чтения следов** или **Выслеживания** и она хочет применить аспект **Внимание к мелочам**. Здесь **Мастер** вправе объявить о снижении эффективности, так как для обнаружения следов в лесу простой наблюдательности может быть недостаточно. _

Давайте для примера выделим архетипы и аспекты из идей персонажей, которые мы перечисляли ранее.
