# Последствия
Во время прохождения **препятствия** персонажи игроков могут получить ответные воздействия, которые мы называем **последствиями**. Последствия возникают вследствие реализации провалов и частичных успехов со стороны **Мастера**, во время полных успехов они не возникают.

Рассмотрим более детально с какими последствиями могут столкнуться персонажи во время преодоления различных препятствий:
...
- Легкие последствия не имеют шкалы и достаточно одного сдвига, чтобы излечиться. Сложность излечения такого последствия при медицинских проверках будет **Легкая** 1(4).
- Тяжелые последствия имеют шкалу в два сдвига и требуют три сдвига для излечения (два для очищения шкалы и один для избавления от последствия). Сложность излечения такого последствия при медицинских проверках будет **Средняя** 2(5).
- Критическое последствие имеет шкалу в три сдвига и требует четыре сдвига для излечения (три для очищения шкалы и один для избавления от последствий). Сложность излечения такого последствия при медицинских проверках будет **Тяжелая** 3(6).
...
### Отличие последствий от угрозы

В пылу игры у игроков возникает желание защититься даже от того, что является последствиями их бросков, а не угрозами, на которые они реагируют. Когда **Мастер** описывает **последствие**, то игрок должен принять его. В этом случае у игрока нет нарративных прав и он не может с помощью описаний изменить последствие, хотя ему все еще доступны возможности описанные в механиках, например вычеты брони и прочее. Если **Мастер** описывает угрозу (т.е. возможное, но не совершившееся последствие), то он передает игроку нарративные права фразой: _«Что ты делаешь?»_. В этом случае игрок вправе делать заявки и проходить проверки для изменения ситуации.

> _**Пример угрозы**: Гоблин цепляется тебе за шею и пытается воткнуть ржавый кинжал тебе в глаз. Что ты делаешь?_

> _**Пример последствия**: Гоблин цепляется тебе за шею и втыкает ржавый кинжал тебе в глаз. Получи критическое последствие — выбитый глаз._
